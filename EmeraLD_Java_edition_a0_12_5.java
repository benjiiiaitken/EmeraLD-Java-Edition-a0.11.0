...
public class EmeraLD_Java_edition_a0_12_5 extends JFrame {
    //the version
    private static String VERSION = "a0.12.0";
    private GameCanvas canvas;
    private String splash;
    public EmeraLD_Java_edition_a0_12_5() {
        //give me your name, ID, Address, SSN, Card number, and your passwords :D
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(EmeraLD_Java_edition_a0_12_5::new);
    }
}
class GameCanvas extends Canvas implements Runnable {
    ...
    private final float fogNear = 50;
    private final float fogFar = 70.0f;
...
//the computer key whisperer (james) :D
    ...
    private void render() {
       ...
       if (keys[KeyEvent.VK_F5]) g.drawString(String.format("XYZ: %.3f / %.3f / %.3f | Rot: %.2f | Blocks: %d ", -camX, camY, camZ, Math.toDegrees(rotY) % 360, world.size(), (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024 / 1024, Runtime.getRuntime().maxMemory() / 1024 / 1024, System.getProperty("java.version")), 20, 100);
        g.drawString("EmeraLD a0.12.5", 20, 60);
