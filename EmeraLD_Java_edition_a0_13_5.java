...
public class EmeraLD_Java_edition_a0_13_5 extends JFrame {
    //the version
    private static String VERSION = "a0.13.5";
    private GameCanvas canvas;
    private String splash;
    public EmeraLD_Java_edition_a0_13_5() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(EmeraLD_Java_edition_a0_13_5::new);
    }
}
...
//the computer key whisperer (james) :D
    ...
    private void render() {
        ...
        g.setColor(Color.WHITE);
       if (keys[KeyEvent.VK_F5]) g.drawString(String.format("XYZ: %.3f / %.3f / %.3f | RotX: %.2f | RotY: %.1f | Blocks: %d", -camX, -camY, camZ, Math.toDegrees(rotY), Math.toDegrees(rotX) % 360, world.size(), (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024 / 1024, Runtime.getRuntime().maxMemory() / 1024 / 1024, System.getProperty("java.version")), 20, 100);
        g.drawString("EmeraLD a0.13.5", 20, 60);
