...
public class EmeraLD_Java_edition_a1_1_1 extends JFrame {
    //the version
    private static final String VERSION = "a1.1.1";
    private final GameCanvas canvas;
    private final String splash;
    public EmeraLD_Java_edition_a1_1_1() {
       ...
       //the welcome stuff & splashes
        ...
        "Creepah, aww man", "possibly a copy of a blocky game", "Half-Life > Quake", "habatalabaubalamtum", "Capes were a no go - SalC1", "K to change splash!", "R = AHHHHH T = :D", "First comment to see this replaces this :o", "Absolute bliss!"};
...
setLocationRelativeTo(null);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(EmeraLD_Java_edition_a1_1_1::new);
    }
}
...
//the computer key whisperer (james) :D
        ...
        if (keys[KeyEvent.VK_K]) splashText = "get tricked bozo";
        //Hellmode :(
    ...
    g.drawString("Developer", width - 110, height - 20);
       ...
       if (keys[KeyEvent.VK_F5]) g.drawString(String.format("XYZ: %.3f / %.3f / %.3f | RotX: %.2f | RotY: %.1f | Blocks: %d | %h | %o | Java: %s | Brightness: %.2f", -camX, -camY, camZ, Math.toDegrees(rotY), Math.toDegrees(rotX) % 360, world.size(), (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1024 / 1024, Runtime.getRuntime().maxMemory() / 1024 / 1024, System.getProperty("java.version"), 1.0f), 20, 100);
        g.drawString("EmeraLD a1.1.1", 20, 60);
